...
# Load model
model_path = r"C:\Users\Sujan H G\OneDrive\Desktop\Internship\unet_model2 (1).h5"  # Update with your model's path
...
if uploaded_file is not None:
    ...
    with col1:
        st.image(image, caption="Original Image", use_column_width=True,width=500)
    with col2:
        segmented_image = (segmented_image * 255).astype(np.uint8)
        st.image(segmented_image, caption="Segmented Mask", use_column_width=True,width=500)
    with col3:
        st.image(cont_img, caption="Contour Image", use_column_width=True,width=500)
